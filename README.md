...
| `width`           | Integer           | 1000                                                               | Integer value to define the maximum width of the HTML canvas onto which all graphics will be displayed. This property is a required value greater than 0                                                                                                              | `<NanoleafLayout canvasWidth={500} />`                                                                                                                      |
| `height`          | Integer           | 1000                                                               | Integer value to define the maximum height of the HTML canvas. This property is a required property greater than 0                                                                                                                                                    | `<NanoleafLayout canvasHeight={500}`                                                                                                                        |                                                                                                                                                  | `<NanoleafLayout canvasHeight={500}`                                                                                                                        |
...
| `useViewbox`      | Boolean           | true                                                               | Use the SVG viewbox property to scale the nanoleaf layout appropriately                                                                                                                                       | `<NanoleafLayout opacity={.5}`                                                                                                                        |                                                                                                                                                  | `<NanoleafLayout useViewbox={true}`                                                                                                                        |
